...
snowsql -a %SNOWSQL_ACCOUNT% -d %SNOWSQL_DATABASE% -u %SNOWSQL_USER% --variable SNOWSQL_PWD=%SNOWSQL_PWD% --authenticator snowflake -f Data\tbldata_download.sql -o quiet=true -o friendly=false -o header=false -o output_format=tsv
